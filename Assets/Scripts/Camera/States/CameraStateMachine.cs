...
namespace hulaohyes.camera.states
{
    public class CameraStateMachine : StateMachine
    {
        ...
        public CameraStateMachine(CameraElement pCamElement0, CameraElement pCamElement1,
            SideCameraElement pSideCamElement0, SideCameraElement pSideCamElement1, RectTransform pMask0, RectTransform pMask1, RectTransform pBar, GameObject pCam0Volume) :base()
        {
            _splitted = new Splitted(this, pCamElement0,pCamElement1, pSideCamElement0, pSideCamElement1, pMask0,pMask1,pBar,pCam0Volume);
