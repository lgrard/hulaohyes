...
class ContentManagerWindow : EditorWindow
{
    ...
    private string[] tabs = { "Add", "Analyze" };
    ...
    private Object hasGameManager;
    private Object hasCamManager;
    ...
    private void OnGUI()
    {
        ...
        currentTab = GUILayout.Toolbar(currentTab, tabs, tabStyle,GUI.ToolbarButtonSize.Fixed, GUILayout.Width(200));
        GUILayout.FlexibleSpace();
    ...
    void AnalyzeScene()
    {
        hasGameManager = GameObject.Find("GameManager");
        hasCamManager = GameObject.Find("CameraManager");
